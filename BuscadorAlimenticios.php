...
<div class="container">
  <div class="dropdown">
    <button class="btn btn-primary dropdown-toggle" id="menu1" type="button" data-toggle="dropdown">Tipo: Alimenticios
    <span class="caret"></span></button>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
      <li role="presentation"><a role="menuitem" tabindex="-1" href="BuscadorPrecuarios.php">Pecuarios</a></li>
      <li role="presentation"><a role="menuitem" tabindex="-1" href="BuscadorInsumosAgricolas.php">Insumos agricolas</a></li>
